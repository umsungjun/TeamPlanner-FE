                    ...
                    <PaddingWrap>
                        <Content>
                            <div className="content-wrap">
                                <h1><strong>"해커톤"</strong> 검색결과</h1>
                                <SearchTabWrap >
                                    <TabWrap sx={{ width: '100%' }}>
                                        <Box sx={{ borderBottom: 1, borderColor: 'divider' }}>
                                            <Tabs value={value} onChange={handleChange} aria-label="basic tabs example">
                                                <StyledTab label={<><h3>전체<br/><strong>95</strong></h3></>} {...a11yProps(0)} sx={{width : '25%'}}/>
                                                <StyledTab label={<><h3>진행 중 공고<br/><strong>0</strong></h3></>} {...a11yProps(1)} sx={{width : '25%'}} />
                                                <StyledTab label={<><h3>마감 된 공고<br/><strong>0</strong></h3></>}{...a11yProps(2)} sx={{width : '25%'}}/>
